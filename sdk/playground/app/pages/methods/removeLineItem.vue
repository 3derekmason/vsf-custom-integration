<template>
  <div class="flex justify-center items-center h-screen">
    <div class="p-5 w-96">
      ...
      <p class="text-gray-50">removeLineItem()</p>
      <div class="box">
...
const res = useState('waiting to call removeLineItem() ...');

async function callEndpoint() {
  const { data } = await sdk.medusa.removeLineItem('test');
  res.value = data;
}

function reset() {
  res.value = 'waiting to call removeLineItem() ...';
}
</script>
