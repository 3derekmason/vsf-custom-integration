<template>
  <div class="flex justify-center items-center h-screen">
    <div class="p-5 w-96">
      ...
      <p class="text-gray-50">createCustomer()</p>
      <div class="box">
...
const res = useState('waiting to call createCustomer() ...');

async function callEndpoint() {
  const { data } = await sdk.medusa.createCustomer('test');
  res.value = data;
}

function reset() {
  res.value = 'waiting to call createCustomer() ...';
}
</script>
