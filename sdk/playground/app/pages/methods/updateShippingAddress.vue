...
const res = useState('waiting to call updateShippingAddress() ...');

async function callEndpoint() {
  const { data } = await sdk.boilerplate.updateShippingAddress('test');
  res.value = data
}

function reset() {
  res.value = 'waiting to call updateShippingAddress() ...'
}
</script>
